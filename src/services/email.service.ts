...
export class EmailService {
    ...
    private static transporter = nodemailer.createTransport({
        ...
        secure: false, // TLS සඳහා (Port 587 නම් false විය යුතුයි)
        auth: {
    ...
    /**
     * User හට Project එක සාර්ථකව upload වූ බව දන්වා යවන Email එක
     */
    static async sendProjectUploadSuccessEmail(
        userEmail: string,
        project: ProjectDto,
    ...
    /**
     * Admin හට අලුත් Project එකක් ලැබුණු බව දන්වා යවන Email එක
     */
    ...
    /**
     * Project එක update කළ විට යවන Email එක
     */
    static async sendProjectUpdateEmail(
        userEmail: string,
        project: ProjectDto,
